...
home = ImageTk.PhotoImage(Image.open('./icons/home.png').resize((40,40),Image.Resampling.LANCZOS))
settings = ImageTk.PhotoImage(Image.open('./icons/settings.png').resize((40,40),Image.Resampling.LANCZOS))
ring = ImageTk.PhotoImage(Image.open('./icons/information.png').resize((40,40),Image.Resampling.LANCZOS))
